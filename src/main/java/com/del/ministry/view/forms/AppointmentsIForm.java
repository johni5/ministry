...
public class AppointmentsIForm extends ObservableIFrame {
    ...
    public AppointmentsIForm() {
        ...
        JComboBox<DistrictNumbers> districtNumbersF = new JComboBox<>();
        ...
        controlPanel.add(FormBuilder.create().
                columns("150, 5, 100, 5, 100, 200, pref:grow, 100")
                .rows("p, 5, p")
                .padding(Paddings.DIALOG)
        ...
        table.getSelectionModel().addListSelectionListener(e -> {
            boolean allowEdit = table.getSelectedRow() > -1 && appointmentCache.get(table.getSelectedRow()).getCompleted() == null;
        ...
        try {
            ...
            ServiceManager.getInstance().findAppointments(
                ...
                tableModel.addRow(new Object[]{
                        ...
                        DateUtilz.formatDate(p.getAssigned()),
