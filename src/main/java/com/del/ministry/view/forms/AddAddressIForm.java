...
public class AddAddressIForm extends JInternalFrame {
    ...
    public AddAddressIForm() {
        ...
        panel.add(FormBuilder.create().
                        columns("50, 5, 200, 5, 100")
                        .rows("p, 5, p, 5, p, 5, p")
                        .padding(Paddings.DIALOG)
                        .add("Поиск:").xy(1, 1).add(maskF).xyw(3, 1, 3)
        ...
        districtAddAddressF.addListSelectionListener(e -> {
