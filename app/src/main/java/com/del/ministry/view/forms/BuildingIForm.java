...
public class BuildingIForm extends ObservableIPanel {
        ...
        btnNewButton.addActionListener(e -> {
            ...
            if (!Utils.isTrimmedEmpty(name)) {
                ...
                try {
                    ...
                    getMainFrame().setStatusError("Ошибка сохранения записи!", e1);
                }
            }
        });
    }
    ...
    public void beforeShow() {
        try {
            ...
            getMainFrame().setStatusError("Ошибка получения списка данных!", e);
        }
        ...
        public void commitChanges() {
            ...
            for (Integer index : changed) {
                try {
                    ...
                    getMainFrame().setStatusError("Ошибка сохранения записи!", e);
                }
            }
            refresh();
        }
        ...
        public void removeItems(int[] rows) {
            ...
            for (int row : rows) {
                try {
                    ...
                    getMainFrame().setStatusError("Ошибка удаления записи!", e);
                }
            }
            refresh();
        }
