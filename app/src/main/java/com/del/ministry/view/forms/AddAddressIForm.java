...
public class AddAddressIForm extends ObservableIFrame {
    ...
    private void add() {
        ...
        if (selectedIndex > -1) {
            ...
            try {
                ...
                getMainFrame().setStatusError("Не удалось привязить адрес", e1);
            }
        }
    }
    ...
    private void init() {
        try {
            ...
            getMainFrame().setStatusError("Ошибка чтения типов адресов", e);
        }
    }
    ...
    private void initDoors() {
        ...
        if (selectedIndex > -1) {
            ...
            try {
                ...
                getMainFrame().setStatusError("Нет доступа к данным", e1);
            }
        }
    }
    ...
    public void setDistrict(District district) {
        ...
        try {
            ...
            getMainFrame().setStatusError("Нет доступа к адресам", e);
        }
    }
}
